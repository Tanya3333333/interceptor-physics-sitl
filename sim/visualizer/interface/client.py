...
class VisualSimState:
    ...
    """
    def __init__(self, win_ip ="10.0.0.129"):
        self.port_home = 55554 
        self.addr_home = (win_ip, self.port_home)
        self.socket_home = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
        
        self.port_state = 55556
        self.addr_state = (win_ip, self.port_state)
    ...
    def send_home_position (self, px4_home_posi):
        ...
        print ("home location sent to visualizer")
    
    def state_collection(self, plant_output):
        """sending fdm states to visualizer"""
        ...
        state_payload = struct.pack('<3f4fQ', N, E, D, qw, qx, qy, qz, t) #3 floats, 4 floats, uint64
